...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default = r'weights/FLIR/CMIT+MACF+3DIAFE-0.46/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/MCAFNet.yaml', help='*.data path')
