...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/FLIR/CMIT+MACF+3DIAFE-0.46/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='datasets/FLIR/RGB/images/FLIR_08936_RGB.jpg', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='datasets/FLIR/IR/images/FLIR_08936_PreviewData.jpeg', help='source')  # file/folder, 0 for webcam
