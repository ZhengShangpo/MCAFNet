...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
                 C3,C3_CCNet,C3TR,C3_SimAM,Conv_SimAM,C3_NonLocal,Conv_NonLocal]:
            ...
            if m is Focus:
                ...
                args = [c1, c2, *args[1:]]
                if m in [BottleneckCSP, C3, C3TR, C3_CCNet,C3_SimAM,C3_NonLocal]:
                    args.insert(2, n)  # number of repeats
                    n = 1

        elif m in [BiFPN_Add2]:
            ...
            args = [c1, args[0]]
        elif m in [Add2_SN, Add2]:
            # print("ch[f]", f, ch[f[0]])
            c2 = ch[f[0]]
            # print("Add2 arg", args[0])
            args = [c2, args[1]]
        elif m in [GPT,GPT_low,GPT_middle,GPT_high]:
            c2 = ch[f[0]]
            args = [c2]
        elif m in [Detect]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='transformer/cam.yaml', help='model.yaml')
