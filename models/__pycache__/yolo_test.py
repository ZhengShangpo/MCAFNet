...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
                 C3,C3_CCNet,C3TR,Conv_DANet, Conv_GCNet, Conv_CCNet,Conv_ANNNet,SppCSPC, Conv_CBAM,Conv_SimAM ]:
            ...
            if m is Focus:
                ...
                args = [c1, c2, *args[1:]]
                if m in [BottleneckCSP, C3, C3TR, C3_CCNet]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='transformer/Non-local_v9.yaml', help='model.yaml')
